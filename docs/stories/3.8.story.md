...
24. Add "Tải xuống CV" (Download) button alongside the PDF preview
...
- [x] **Task 13: Add PDF Preview Section to Recruiter CV Detail Page (AC: 23, 24)**
    ...
    - [x] Add new Card section "Hồ sơ gốc" (Original CV) with:
    ...
    - [x] Add "Tải xuống CV" button that triggers download
...
└── app/modules/jobs/
    └── router.py                         # Add recruiter CV access endpoint + download endpoint
```
