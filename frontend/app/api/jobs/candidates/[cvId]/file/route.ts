 ...
 * 
 * This is for candidates found via semantic search (no JD context).
 * 
...
export async function GET(
  ...
  // Build backend URL for search context (no JD)
  const backendUrl =
    process.env.NEXT_PUBLIC_API_URL || "http://localhost:8000/api/v1";
  const fileUrl = `${backendUrl}/jobs/candidates/${cvId}/file${
